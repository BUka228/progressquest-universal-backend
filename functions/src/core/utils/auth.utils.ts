...
import {
  TeamMemberDocument,
} from "../../features/team/types/firestore.types";
import {
  WorkspaceDocument,
  WorkspaceMemberDocument,
} from "../../features/workspace/types/firestore.types";
...
export async function assertPersonalWorkspaceOwner(
  ...
  try {
    ...
    if (!workspaceDoc.exists) {
      console.warn(
        "[AuthUtil] Workspace " + workspaceId + " not found."
      );
      throw new HttpsError(
        "not-found",
    ...
    console.error(
      "[AuthUtil] Error in assertPersonalWorkspaceOwner for ws " +
        workspaceId +
        ":",
      error
    );
...
export async function getUserRoleInTeam(
  ...
  try {
    ...
    console.error(
      "[AuthUtil] Error fetching role for user " +
        userId +
        " in team " +
        teamId +
        ":",
